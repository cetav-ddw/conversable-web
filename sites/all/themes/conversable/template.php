 ...
 */
function conversable_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
 ...
 */
function conversable_html_head_alter(&$head_elements) {
 ...
 */
function conversable_page_alter(&$page) {
...
function conversable_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function conversable_preprocess_block(&$vars, $hook) {
  // Add a striping class.
